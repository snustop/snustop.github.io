...
availability-descr: Подходят сроки, до 15 августа
...
Просрочен, до 3 июня, но это не означает что его нельзя использовать (это не молочные продукты). Последний день просрочки, потому что осталось мало.<br>
